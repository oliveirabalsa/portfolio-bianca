export const ProjectHeader = {
    title: 'Mentor Cycle',
    description: 'Transformando Mentoria em Experiência Digital',
    badges: ['UX Design', 'UI Design', 'Protótipo']
}
...
export const ProjectObjective = {
    title: 'Nossa Solução',
    descriptions: [
        'Para resolver a dor de orientação e progresso, criamos um sistema de trilha personalizada com marcos de aprendizagem, que ajudam mentor e mentorado a saber onde estão e o que precisam fazer em seguida.',
        'A agenda integrada com lembretes e acompanhamento dos encontros permitiu que os mentores tivessem mais controle do tempo investido e que os mentorados não perdessem o engajamento ao longo do processo.',
        'Além do aprendizado técnico, o projeto ofereceu direcionamento sobre posicionamento no mercado, construção de networking, preparação para entrevistas e definição de metas profissionais. O objetivo foi impulsionar não apenas o conhecimento, mas também a autoconfiança e a clareza de trajetória dos participantes'
    ],
    solution: [
